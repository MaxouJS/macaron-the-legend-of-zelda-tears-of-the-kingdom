      ...
      <div className="-mt-[100vh]">
        ...
        <div className="flex h-screen w-screen items-center justify-center text-center container mx-auto p-8 text-neutral-50">
          <header className="flex flex-col items-center justify-center space-y-8 md:-mt-32 -mt-24">
            <h2 className="bg-gradient-to-r from-transparent via-emerald-600/75 to-transparent backdrop-blur-none font-black lg:text-2xl border-y border-neutral-50/50 py-4 mx-4">
              <span className="drop-shadow-[2px_2px_rgba(0,0,0,0.5)]">The adventure begins on May 12</span>
            </h2>
            <h3 className="bg-gradient-to-r from-transparent via-emerald-600/75 to-transparent backdrop-blur-none lg:text-md md:text-sm text-xs border-y border-neutral-50/50 py-4 mx-4">
            ...
            <YouTube videoId="fYZuiFDQwQw" className="backdrop-blur-none mx-4" opts={{ height: 180, width: 320 }} />
