...
export default function Navigation() {
  return (
    <div className="fixed w-full bg-gradient-to-r from-[red] via-transparent to-[red] backdrop-blur-md shadow-xl shadow-white/10 border-b border-white/50 text-white z-10 font-sans">
